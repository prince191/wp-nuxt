          ...
          <div class="w-full px-4">
            <div class="flex flex-wrap -mx-4">
              <div class="w-full px-4 lg:w-8/12">
                <div>
                  <h2 class="wow fadeInUp mb-2 text-2xl font-bold text-dark dark:text-white sm:text-3xl md:text-[35px] md:leading-[1.28]"
                      data-wow-delay=".1s
                    ">
                  ...
                  <div class="flex flex-wrap items-center mb-2">
                    <div class="flex items-center mb-4 mr-5 md:mr-10">
                      <div class="w-10 h-10 mr-4 overflow-hidden rounded-full">
                        <img src="/images/blog/author-01.png"
                             alt="image"
                             class="w-full" />
                      </div>
                  ...
                  <div class="wow fadeInUp relative z-20 mb-[50px] h-[300px] overflow-hidden rounded-[5px] md:h-[400px] lg:h-[500px]">
                    <img src="/images/blog/blog-details-01.jpg"
                         alt="image"
                         class="object-cover object-center w-full h-full" />
                  </div>

                  <p class="mb-6 text-base wow fadeInUp text-body-color dark:text-dark-6"
                     data-wow-delay=".1s">
                  ...
                  <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6"
                     data-wow-delay=".1s">
                    ...
                    <div>
                      <span class="absolute top-0 left-0">
                        <svg width="103"
                          ...
                          <defs>
                            <linearGradient id="paint0_linear_2014_9016"
                                            x1="-101.591"
                                            y1="-50.4346"
                                            x2="49.1618"
                                            y2="-49.6518"
                      ...
                      <span class="absolute bottom-0 right-0">
                        <svg width="102"
                          ...
                          <defs>
                            <linearGradient id="paint0_linear_2014_9017"
                                            x1="0.409163"
                                            y1="51.5654"
                                            x2="151.162"
                                            y2="52.3482"
                  ...
                  <div class="flex flex-wrap items-center mb-12 -mx-4">
                    ...
                    <div class="w-full px-4 md:w-1/2">
                      <div class="flex items-center wow fadeInUp md:justify-end"
                           data-wow-delay=".1s">
                          ...
                          <a href="javascript:void(0)">
                            <svg width="32"
                              ...
                              <path d="M16 32C24.8366 32 32 24.8366 32 16C32 7.16344 24.8366 0 16 0C7.16344 0 0 7.16344 0 16C0 24.8366 7.16344 32 16 32Z"
                                    fill="#1877F2" />
                              <path d="M17 15.5399V12.7518C17 11.6726 17.8954 10.7976 19 10.7976H21V7.86631L18.285 7.67682C15.9695 7.51522 14 9.30709 14 11.5753V15.5399H11V18.4712H14V24.3334H17V18.4712H20L21 15.5399H17Z"
                                    fill="white" />
                            </svg>
                          </a>
                          <a href="javascript:void(0)">
              ...
              <div class="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  <div class="flex flex-wrap mb-8 -mx-4">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3"
                        ...
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-01.png"
                               alt="image"
                               class="w-full" />
                        </div>
                        <div class="w-full">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3"
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-02.png"
                               alt="image"
                               class="w-full" />
                        </div>
                        <div class="w-full">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3"
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-03.png"
                               alt="image"
                               class="w-full" />
                        </div>
                        <div class="w-full">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="flex items-center w-full pb-5 mb-5 border-0 wow fadeInUp border-stroke dark:border-dark-3 md:border-b lg:border-0"
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-04.png"
                               alt="image"
                               class="w-full" />
                        </div>
                        <div class="w-full">
                  ...
                  <div class="wow fadeInUp mb-12 overflow-hidden rounded-[5px]"
                       data-wow-delay=".1s">
                    <img src="/images/blog/bannder-ad.png"
                         alt="image"
                         class="w-full" />
                  </div>
                </div>
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".2s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="blog-details.html" class="block">
                  <img src="/images/blog/blog-03.jpg"
                       alt="image"
                       class="w-full transition group-hover:rotate-6 group-hover:scale-125" />
                </a>
              </div>
    ...
    head() {
      return {
        ...
        meta: [
          {
            property: "og:url",
            content: process.env.baseUrl + "keyword-manager",
          },
        ...
        link: [
          {
            rel: "canonical",
            href: process.env.baseUrl + "keyword-manager",
          },
        ],
      };
    },
