          ...
          <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <div class="flex flex-col shadow my-4" v-for="item in cateItems" :key="item.slug" v-show="item.posts.nodes[0]">
              ...
              <NuxtLink :to="item.slug" class="hover:opacity-75" v-if="item.posts.nodes[0]?.featuredImage?.node?.sourceUrl">
                <nuxt-img :src="item.posts.nodes[0]?.featuredImage?.node?.sourceUrl" quality="20" class="h-[400px] w-full" alt="item.posts.nodes[0]?.featuredImage?.node?.altText"/>
              </NuxtLink>
          ...
          <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
            ...
            <div class="w-full bg-white shadow flex flex-col my-4 p-6">
              ...
              <div class="grid grid-cols-3 gap-3">
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=1"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=2"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=3"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=4"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=5"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=6"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=7"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=8"/>
                <nuxt-img class="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=9"/>
              </div>
